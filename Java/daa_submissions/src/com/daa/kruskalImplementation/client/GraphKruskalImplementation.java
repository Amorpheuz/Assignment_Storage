package com.daa.kruskalImplementation.client;

import com.daa.kruskalImplementation.domain.Edge;
import com.daa.kruskalImplementation.domain.Graph;
...
public class GraphKruskalImplementation {
    public static void main(String[] args) throws IOException {
        ...
        Edge[] resultGraph = graph.getKrusKalMST();
        System.out.println("\n\nMST: ");
        for (int i = 0; i < (resultGraph.length - 1); i++) {
            Edge e = resultGraph[i];
